...
The formula is: 
$$Y_i = \beta_0 + \beta_1X_(people,i) + \epsilon_i$$ 
...
**Data**
```{r, echo=FALSE}
head(income_metal_health_data)#data collected and anaylysed 
```

- income_range: different income groups acrroding to each repondent's total income befrore tax.
- income: number of people in different income group.
- excellenct: number of people who self rated their mental health condition as "Excellent" within each income group.
- proportion(excellent/income): proportion of people who rated themselves as "Excellect" with respect to each income group.
...
In our model results, the bar plot shows that the general trend between the number of people and income groups is that the amount of people decreases in each income group as income increases. While a weak negative correlation between the number of people and the proportion of people who rated their mental health condition as “Excellent" within different income ranges appears in the scatterplot. 
...
Results of the model allow us to infer that people in low-income groups are associated with higher risks for anxiety and mental disorders, which means that people who have lower income are usually under greater pressure than the ones earn more money in nowadays society. Therefore, mental health status is affected by income statistical significantly, which proves the assumption in the introduction that lower-income is related to mental disorders. According to McElreath, this model represents the small world to a great extend. As under the assumption that small world describes the real world accurately, linear regression model performs the effects of income on mental health status under reasonable claims from an optimal perspective. However, it represents the large world to a small extend. Since the optimal assumption of the model in the small world might be affected by other variables. This model cannot fully represent the condition of the large world.

## Weaknesses

- As data of the Year 2017 was constrained from the Canadian General Social Survey (GSS), results generated from this dataset could only be used to explain the effects of income on the mental health status of Canadian within this year, not a general trend that could last continuously.
- In this dataset, people were putting into different income ranges. The association between income and mental health status could not be observed directly from the plot. To improve this, each person's actual income could be collected.
Lurking variables might appear in the analysis. Some potential lurking variables like physical health conditions or stressful life situations could also affect mental health status other than income. For instance, two people with the same salary but different marital status might rate their metal health conditions differently. As the person who feels loved by his/her family usually has a more positive mood toward life. Therefore, other variables should be considered in the analysis in order to get a more precise result.
- As only 6 data points of the proportion of people who rated their mental health condition as “Excellent" were used for the analysis, each point heavily influenced the result. To decrease the margin of errors, proportions of people in other mental health groups could also be utilized for the analysis.

## Next Steps

- More data could be collected from the survey. Instead of arranging people into several income ranges, people’s actual income could be included in the survey. By analyzing the distribution of the mental health status of people with different actual income, the association could be concluded more precisely from the regression model.
- Other factors that impact mental health should be considered for a more precise analysis. People could be separated by genders. By comparing the proportions of people with different genders having "Excellent" mental health condition in each income group, the influence of genders toward mental health status could be also concluded in the analysis as a subsequent study.
